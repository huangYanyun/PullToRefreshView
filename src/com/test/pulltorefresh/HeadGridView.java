 ...
 * See {@link HeadGridView#addHeaderView(View, Object, boolean)}
 * See {@link HeadGridView#addFooterView(View, Object, boolean)}
 */
public class HeadGridView extends GridView {
    ...
    public HeadGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (adapter != null && !(adapter instanceof HeaderViewGridAdapter)) {
            throw new IllegalStateException(
                    "Cannot add header view to grid before setAdapter.");
        }
    ...
    public void addFooterView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null && !(mAdapter instanceof HeaderViewGridAdapter)) {
            throw new IllegalStateException(
                    "Cannot add footer view to grid before setAdapter.");
        }
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = HeadGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = HeadGridView.this.getMeasuredWidth()
                    - HeadGridView.this.getPaddingLeft()
                    - HeadGridView.this.getPaddingRight();
